...
<div class="main">
	...
	<h2><span>Complaints Form</span></h2>
		<form action="complaint.htm" method="post" commandName="complaint">
			
			
			<input placeholder="Full Name" name="studentName" type="text" required="">
			<input placeholder="Email" name="emailId" type="text" required="">
			<input placeholder="Phone Number" name="contact" type="text" required="">

		 <textarea rows="4" cols="30" name="complaints" placeholder="Enter Complaints"></textarea><br><br>
